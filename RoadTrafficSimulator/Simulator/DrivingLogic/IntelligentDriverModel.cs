...
namespace RoadTrafficSimulator.Simulator.DrivingLogic
{
    ...
    {
        public static float SAFE_TIME_HEADWAY = 3.5f;    // Minimum possible time to car in front (in seconds)
        ...
        /// <returns></returns>
        public static float ComputeAccelerationIntensity(Car curr)
        {
            // Car info
            float currSpeed = Vector2.Dot(curr.Velocity, curr.TrajectoryDirection); // Car speed along direction of trajectory
